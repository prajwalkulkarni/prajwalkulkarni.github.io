        ...
        <div class="flex flex-col justify-between">
          <div>
            ...
            <div class="text-gray-700 mt-8">
              Got something to say? or perhaps something to ask? Fill in the details or send me an <span class="underline">email</span> instead. I'll get back ASAP.
            </div>
          </div>
              ...
              <form action="https://submit-form.com/N6nlOfcD">
                  <div class="">
                      ...
                      <div class="mt-8">
                          ...
                          <input name="mail" class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                              type="text" required />
                      </div>
                      <div class="mt-8">
